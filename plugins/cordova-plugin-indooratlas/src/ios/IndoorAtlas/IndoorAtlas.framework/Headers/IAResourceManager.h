 ...
 *
 * @param floorPlanId Identifier of the floor plan to fetch from server.
 * @param completionBlock A block to be called when the floor plan fetch is completed.
 *
 *     - *floorplan*: An object representing fetched floor plan. If an error occured, this parameter is nil.
 ...
 * @param completionBlock A block to be called when the image download is completed.
 *
 ...
 *
 * @param floorPlanUrl URL of the floor plan to fetch image file data for.
